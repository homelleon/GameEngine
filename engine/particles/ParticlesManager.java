...
public class ParticlesManager {
	...
	public static List<ParticleSystem> createParticleSystem(Loader loader) {
		...
		ParticleTexture cosmicPTexture = new ParticleTexture(loader.loadTexture(EngineSettings.PARTICLE_TEXTURE_PATH, "cosmic"), 4, true);
		...
		ParticleTexture starPTexture = new ParticleTexture(loader.loadTexture(EngineSettings.PARTICLE_TEXTURE_PATH, "particleStar"), 1, true);
