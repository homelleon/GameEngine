...
public class ES {
	...
	public final static String SHADERS_PATH = SOURCE_PATH + "shaders/";
	public final static String ENTITY_SHADER_PATH = SHADERS_PATH + "entities/";
	public final static String NORMAL_MAP_SHADER_PATH = ENTITY_SHADER_PATH;
	public final static String BOUNDING_SHADER_PATH = SHADERS_PATH + "boundings/";
	public final static String TERRAIN_SHADER_PATH = SHADERS_PATH + "terrains/";
	public final static String VOXEL_SHADER_PATH = SHADERS_PATH + "voxels/";
	public final static String GUI_SHADER_PATH = SHADERS_PATH + "guiTextures/";
	public final static String SKYBOX_SHADER_PATH = SHADERS_PATH + "skybox/";	
	public final static String WATER_SHADER_PATH = SHADERS_PATH + "water/";
	public final static String PARTICLE_SHADER_PATH = SHADERS_PATH + "particles/";
	public final static String SHADOW_SHADER_PATH = SHADERS_PATH + "shadows/";
	public final static String FONT_SHADER_PATH = SHADERS_PATH + "font/";
