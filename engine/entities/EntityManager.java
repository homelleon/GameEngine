...
public class EntityManager {
	...
	public static List<Entity> createNormalMappedEntities(Loader loader) {
		...
		/*Creating entities*/
		Entity barrel = new EntityTextured("barrel", ENTITY_TYPE_NORMAL, barrelModel, new Vector3f(200, 0, 200), 0,0,0,1);
		Entity boulder = new EntityTextured("boulder", ENTITY_TYPE_NORMAL, boulderModel, new Vector3f(250, 0, 250), 0,0,0,1);
