...
public interface TerrainInterface {
	 ...
	 * 
	 * @param isVisible {@link Boolean} value to define terrain visibity
	 * 		  parameter
	 */
	...
	/**
	 * Gets texture map of intensity of blending that effects on terrain lightning
	 * system.
	 * 
	...
	/**
	 * Gets terrain height value (y-coordinate in game world space) due to
	 * input x and z coodrinates in game world space.
	 * 
	 * @param worldX {@link Float} value of x-coordinate in game world space
	 * @param worldZ {@link Float} value of z-coordinate in game world space
	 * @return
	 */
