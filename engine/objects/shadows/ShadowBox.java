...
public class ShadowBox {
	...
	private static final float OFFSET = ES.SHADOW_DISTANCE;
	...
	protected void update() {
		...
		toFar.scale(ES.SHADOW_DISTANCE);
		Vector3f toNear = new Vector3f(forwardVector);
		toNear.scale(ES.NEAR_PLANE);
	...
	private void calculateWidthsAndHeights() {
		farWidth = (float) (ES.SHADOW_DISTANCE * Math.tan(Math.toRadians(ES.FOV)));
		nearWidth = (float) (ES.NEAR_PLANE
				* Math.tan(Math.toRadians(ES.FOV)));
