...
public class KeyboardGame {
	...
	/**
	 * Method that clear keys massive to set it as not pressed and not 
	 * released. After that it checks if there was any key event and set
	 * event key as 'pressed' or 'released'. 
	 * <p><i>note: </i>use that method before LWJGL Display.update() method.
	 *  
	 ...
	 *  
	 * @param key 
	 * 				int value of key to check for (use LWJGL Keyboard constants for that value) 
	...
	/**
	 * Method that repeat LWJGL method isKeyDown(int key) and check if key is pressed
	 * down.
	 * <p>Unlike {@link #isKeyPressed(int)} return true if key is holding down.
	 * 
	 * @param key
	 * 				int value of key to check for (use LWJGL Keyboard constants for that value)
