...
public class VoxelRenderer {
	...
	public void render(ChunkManagerInterface chunkManager, Vector4f clipPlane, Collection<Light> lights,
			CameraInterface camera, Matrix4f toShadowMapSpace, Frustum frustum) {
		shader.start();
