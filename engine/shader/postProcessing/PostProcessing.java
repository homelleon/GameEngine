...
import shader.postProcessing.gaussianBlur.VerticalBlur;
...
public class PostProcessing {
	...
	public static void doPostProcessing(int colourTexture, int brightTexture) {
		...
		if (isBloomed && isBlured) {
			...
			combineFilter.render(colourTexture, vBlur2.getOutputTexture(), vBlur4.getOutputTexture(),
					vBlur8.getOutputTexture());
		} else if (isBlured) {
