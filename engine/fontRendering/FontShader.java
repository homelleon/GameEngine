...
public class FontShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = ES.FONT_SHADER_PATH + "fontVertex.txt";
	private static final String FRAGMENT_FILE = ES.FONT_SHADER_PATH + "fontFragment.txt";
