 ...
 * @see VectorBuilder3i
 */
public interface VectorBuilder3<T, R> {
	 ...
	 * @return builder
	 */
	VectorBuilder3<T, R> setZ(T z);
	
	VectorBuilder3<T, R> set(T x, T y, T z);
