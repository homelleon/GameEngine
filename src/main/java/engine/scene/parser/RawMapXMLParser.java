 ...
 * @see RawManaer
 */
public class RawMapXMLParser extends XMLParser implements IObjectParser<RawManager> {
	...
	@Override
	public RawManager parse() {
		RawManager map = new RawManager();
	...
	private void parseMeshes(Node node, RawManager map) {
		if (EngineDebug.hasDebugPermission()) {
	...
	private void parseTextures(Node node, RawManager map) {
		if (EngineDebug.hasDebugPermission()) {
	...
	private void parseMaterials(Node node, RawManager map) {
		if (EngineDebug.hasDebugPermission()) {
	...
	private void parseTerrainPacks(Node node, RawManager map) {
		if (EngineDebug.hasDebugPermission()) {
	...
	private void parseModels(Node node, RawManager map) {
		if (EngineDebug.hasDebugPermission()) {
